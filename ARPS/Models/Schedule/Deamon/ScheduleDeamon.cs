using ARPS.Models.Schedule.Deamon;
using System;
...
namespace ARPS.Models.Schedule
{
    public static class ScheduleDeamon
    {
        /// <summary>
        /// Startet den die abarbeitung der offenen Mitgliedschaften
        /// </summary>
